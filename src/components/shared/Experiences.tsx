...
export default function Experiences() {
    ...
    return (
        <section id="experiences" className="frame-container container mx-auto py-24 px-4 md:px-0">
            ...
            <div className="inner-panel">
                <div className="panel-content">
                    <ol className="relative space-y-14 border-l border-foreground-subtle/25 pl-6 md:space-y-20 md:pl-12">
