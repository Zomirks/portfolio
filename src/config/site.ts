...
export const siteConfig = {
    ...
    description:
        "Développeur avec 7+ ans d'expérience web, spécialisé en Laravel, React, TypeScript & Next.js. Interfaces performantes, accessibles et pensées pour la production.",
    ...
    socials: [
        ...
        {
            label: 'LinkedIn',
            href: 'https://www.linkedin.com/in/cyril-fischer/',
